...
document.write(
    'Aluno1 => nome: ' + Aluno1.nome + ' matricula: ' + Aluno1.matricula +' (' + typeof(Aluno1.matricula) + ')' + '<br>'
)

document.write(
    'Aluno2 => nome: ' + Aluno2.nome + ' matricula: ' + Aluno2.matricula +' (' + typeof(Aluno2.matricula) + ')'
)