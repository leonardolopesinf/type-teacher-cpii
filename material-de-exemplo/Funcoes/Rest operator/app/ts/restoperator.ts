...
function saudar(saudacao: string, ...nomes: string[]) { // Aqui colocamos o Rest (...) no parametro nome  , ou seja , Não há limite para o parametro nome . OBS:ele não é obrigatório ter valor
